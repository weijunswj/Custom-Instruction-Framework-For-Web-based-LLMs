...
* You own G1 architecture/G2 Design Locks, escalation, GitHub state, exact-head acceptance/merge; prompt model info: model/reasoning/equivalent only.
...
* Model/effort ≠ authority; assign models.
