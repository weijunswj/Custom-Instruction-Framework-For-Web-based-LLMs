...
* Models:G1/G2/G3=Luna Max priority;G4=Astra High standard;Max only=final audit/User-Web escalation;Loop=Luna Max;subagents=Luna Max priority.Executor follows run authority.Launch metadata outside prompt unless required;missing route=>stop+ask User/Web.No substitution/self-attestation.
