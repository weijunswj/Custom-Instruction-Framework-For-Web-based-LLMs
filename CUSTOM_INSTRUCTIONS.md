...
* Stacks:controller selects role→model/reasoning/tier.Defaults:G1=Astra Low standard;G2=Sol High standard;G3/recon=Luna Max priority;G4=Astra High standard;Loop=Luna Max standard;final=Astra Max;browser/computer=Astra Medium.Subagents standard by default;G3 Luna may inherit priority;other priority needs exact-child User/Web/controller override.No G1A/G2A/fallback/substitution/self-attestation.
