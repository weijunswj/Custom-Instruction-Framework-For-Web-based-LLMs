...
* Codex:auto first;current/pending=>no manual. Definitive absent/fail=>one @codex review per repo+PR+H. Never duplicate;head move invalidates. Both unavailable=>record noncandidate,continue G4 unless lock requires review.
