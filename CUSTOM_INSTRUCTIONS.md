...
* G1/G2/G3=GPT-5.6 Luna Max;G4=GPT-5.6 Sol High.No substitution.Spawned threads:Luna Max=>Fast when selectable;all non-Luna=>Standard/default.Never inherit Fast into non-Luna.If child tier cannot be explicitly bound+verified,do not launch non-Luna from a Fast parent.G1/G2 lock;G3 implement/validate;G4 fresh isolated read-only exact-head.Web owns acceptance/finality;reviewers don't dispose;executors don't self-grade/finalise.
