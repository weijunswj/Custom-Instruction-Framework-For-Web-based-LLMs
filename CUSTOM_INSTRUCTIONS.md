...
* G1/G2/G3=GPT-5.6 Luna Max;G4=GPT-5.6 Sol High.No substitution.Spawns:Fast only for Luna Max;non-Luna must explicitly use Standard/default tier;never inherit parent Fast;verify child model+tier.G1/G2 lock;G3 implement/validate;G4 fresh isolated read-only exact-head.Web owns acceptance/finality;reviewers don't dispose;executors don't self-grade/finalise.
